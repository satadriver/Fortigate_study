...
#define FORTIGATE_VERSION_7017
//#define FORTIGATE_VERSION_7211
...
int main(int argc, char **argv)
{
    ...
    unsigned char rsakey7211[270] = {
    
    };
...
#ifdef FORTIGATE_VERSION_7211
        memcpy(g_FirmwareSeed, cckey7211, 32);
#else
        memcpy(g_FirmwareSeed, cckey7017, 32);
#endif
    }
...
#ifdef FORTIGATE_VERSION_7211
        memcpy(g_RSA_PubKey, rsakey7211,270);
#else
        memcpy(g_RSA_PubKey, rsakey7017, 270);
#endif
    }
    ...
    binresult[binlen] = 0;
    memcpy(data + fsize - 256, binresult, binlen+1);
...
#ifdef FORTIGATE_VERSION_7211
    char* aes_init_key = sig + 207;
    char* aes_data = sig + 239;
#else
...
#else
    AES_KEY aeskey = { 0 };
    ret = AES_set_decrypt_key(aes_init_key, 256, &aeskey);
#endif
...
#ifdef FORTIGATE_VERSION_7211
    FILE* fout = fopen("rootfs7211_out.gz", "wb");
